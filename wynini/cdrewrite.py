...
class CDRewrite():
    ...
    def rule(phi, psi, lamb, rho, replace=None):
        """
...
if __name__ == "__main__":
    ...
    regexper = cdrewrite.regexper

    beta1 = '(a|b)'
    alpha1 = 
    tau1 = cdrewrite.marker( \
        beta1, sigma, type=1, insertions=['_#_'], deletions=[])
    tau1.draw('fig/tau1.dot', acceptor=False)

    beta2 = '(a|b)'
    tau2 = cdrwrite.marker \
        (beta2, sigma, type=2, insertions=[], deletions=['_#_'])
